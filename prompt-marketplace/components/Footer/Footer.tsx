        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.brandSection}>
            <Link href="/" className={styles.brand}>
              ...
              <span className={styles.brandName}>PromptMarket</span>
            </Link>
            <p className={styles.brandDescription}>
              The premier library for high-quality AI prompts. Discover prompts that unlock the full potential of AI tools.
            </p>
          ...
          <div className={styles.quickLinksSection}>
            <div className={styles.linkGroup}>
              <h3 className={styles.linkGroupTitle}>Quick Links</h3>
              <ul className={styles.linkList}>
                <li><Link href="/browse" className={styles.link}>Browse Prompts</Link></li>
                ...
                <li><Link href="/sell" className={styles.link}>Sell Prompts</Link></li>
              </ul>
            </div>
